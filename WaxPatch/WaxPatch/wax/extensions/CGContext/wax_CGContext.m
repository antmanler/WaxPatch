...
static int setFillColor(lua_State *L)
{
    ...
    if (lua_gettop(L) >= 4) {
        ...
        UIColor **color = nil;
        wax_copyToObjc(L, @encode(UIColor *), 2, nil, (void**)color);
...
static int setStrokeColor(lua_State *L)
{
    ...
    if (lua_gettop(L) >= 4) {
        ...
        UIColor **color = nil;
        wax_copyToObjc(L, @encode(id), 2, nil, (void**)color);
...
static int fillRect(lua_State *L)
{
    CGContextRef c = (CGContextRef)lua_topointer(L, 1);
    CGRect *rect = nil;
    wax_copyToObjc(L, @encode(CGRect), 2, nil, (void**)rect);
...
static int fillPath(lua_State *L)
{
    ...
    if (indexCount % 2 != 0) {
        luaL_error(L, "Requires an even number of indexes for points.");
    }
...
static int drawLinearGradient(lua_State *L)
{
    CGContextRef c = (CGContextRef)lua_topointer(L, 1);
    CGPoint *start = nil;
    wax_copyToObjc(L, @encode(CGPoint), 2, nil, (void**)start);
    CGPoint *end = nil;
    wax_copyToObjc(L, @encode(CGPoint), 3, nil, (void**)end);
    NSArray *colors = nil;
    wax_copyToObjc(L, @encode(NSArray *), 4, nil, (void**)colors);
